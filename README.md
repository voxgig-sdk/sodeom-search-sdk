...
This is an unofficial SDK for the Sodeom Search public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/sodeom-search` | `npm install @voxgig-sdk/sodeom-search` |
| Python | `voxgig-sdk-sodeom-search` | `pip install voxgig-sdk-sodeom-search` |
| PHP | `voxgig-sdk/sodeom-search` | `composer require voxgig-sdk/sodeom-search` |
| Golang | `github.com/voxgig-sdk/sodeom-search-sdk/go` | `go get github.com/voxgig-sdk/sodeom-search-sdk/go` |
| Ruby | `voxgig-sdk-sodeom-search` | `gem install voxgig-sdk-sodeom-search` |
| Lua | `voxgig-sdk-sodeom-search` | `luarocks install voxgig-sdk-sodeom-search` |
