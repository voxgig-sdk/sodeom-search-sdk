...
from sodeomsearch_sdk.utility import register

# Load features
from sodeomsearch_sdk.feature.base_feature import SodeomSearchBaseFeature
from sodeomsearch_sdk.features import _has_feature, _make_feature
...
class SodeomSearchSDK:
    ...
    def get_utility(self):
        return SodeomSearchUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SodeomSearchSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from sodeomsearch_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SodeomSearchSDK":
        if sdkopts is None:
            sdkopts = {}
