...
class SodeomSearchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SodeomSearchTestRunner.getenv("SODEOMSEARCH_TEST_LIVE")
        override = SodeomSearchTestRunner.getenv("SODEOMSEARCH_TEST_OVERRIDE")
        ...
        explain = SodeomSearchTestRunner.getenv("SODEOMSEARCH_TEST_EXPLAIN")
