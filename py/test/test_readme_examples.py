# SodeomSearch SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SodeomSearchSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SodeomSearchSDK(...) and SodeomSearchSDK.test(...) become
#      SodeomSearchSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sodeomsearch_sdk"
_SDK_CLASS = "SodeomSearchSDK"
