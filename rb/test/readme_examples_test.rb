...
#      offline in seeded test mode (SodeomSearchSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SodeomSearch_sdk.rb")
  SDK_CLASS = "SodeomSearchSDK"
