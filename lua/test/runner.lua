...
function runner.env_override(m)
  local live = runner.getenv("SODEOMSEARCH_TEST_LIVE")
  local override = runner.getenv("SODEOMSEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SODEOMSEARCH_TEST_EXPLAIN")
