# SodeomSearch Lua SDK



The Lua SDK for the SodeomSearch API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/sodeom-search-sdk/releases)),
...
```
lua/
├── sodeom-search_sdk.lua    -- Main SDK module
...
The main module (`sodeom-search_sdk`) exports the SDK constructor
