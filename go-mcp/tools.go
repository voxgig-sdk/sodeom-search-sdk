...
func registerTools(server *mcp.Server, client *sdk.SodeomSearchSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sodeom-search_list",
		Description: "List records from SodeomSearch. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sodeom-search_load",
		Description: "Load a single record from SodeomSearch. " +
...
func runOp(client *sdk.SodeomSearchSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SodeomSearchSDK, name string) (sdk.SodeomSearchEntity, error) {
