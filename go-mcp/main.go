// Command SodeomSearch-mcp is an MCP server exposing the SodeomSearch
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SodeomSearch_list  — list records of an entity
//	SodeomSearch_load  — load a single record of an entity
//
