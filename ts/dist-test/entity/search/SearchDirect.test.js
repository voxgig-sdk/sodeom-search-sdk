...
(0, node_test_1.describe)('SearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SodeomSearchSDK({
...
function liveScenariosActive() { return false && process.env.SODEOM_SEARCH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SodeomSearchSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SODEOM_SEARCH_TEST_SEARCH_ENTID'];
    ...
    const client = new __1.SodeomSearchSDK({
        base: 'http://localhost:8080',
