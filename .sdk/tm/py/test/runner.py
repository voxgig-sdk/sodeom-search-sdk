...
class SodeomSearchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SodeomSearchTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SodeomSearchTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SodeomSearchTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
