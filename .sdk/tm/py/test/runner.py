...
class SodeomSearchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SodeomSearchTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SodeomSearchTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SodeomSearchTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
