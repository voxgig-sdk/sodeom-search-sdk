...
// SodeomSearch SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SodeomSearchOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SodeomSearchOmni::structfix($now, Struct::undef()))
                        !== json_encode(SodeomSearchOmni::structfix($val, Struct::undef()))) {
