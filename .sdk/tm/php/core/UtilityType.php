...
// SodeomSearch SDK utility type

class SodeomSearchUtility
{
    ...
    public static function copy(SodeomSearchUtility $src): SodeomSearchUtility
    {
        $u = new SodeomSearchUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
