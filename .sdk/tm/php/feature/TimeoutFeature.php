...
// SodeomSearch SDK timeout feature
...
class SodeomSearchTimeoutFeature extends SodeomSearchBaseFeature
{
    ...
    private function _with_timeout(SodeomSearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SodeomSearchContext $_ctx, float $ms): void
    {
        $client = $this->client;
