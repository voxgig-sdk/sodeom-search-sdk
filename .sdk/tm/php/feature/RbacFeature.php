...
class SodeomSearchRbacFeature extends SodeomSearchBaseFeature
{
    ...
    private function _required(SodeomSearchContext $ctx): ?string
    {
    ...
    private function _reject(SodeomSearchContext $ctx, string $required): void
    {
    ...
    private function _track(SodeomSearchContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
