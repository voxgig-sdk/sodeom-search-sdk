...
// SodeomSearch SDK ratelimit feature
...
class SodeomSearchRatelimitFeature extends SodeomSearchBaseFeature
{
    ...
    private function _acquire(SodeomSearchContext $ctx): void
    {
    ...
    private function _track(SodeomSearchContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
