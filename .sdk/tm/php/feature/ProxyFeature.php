...
// SodeomSearch SDK proxy feature
...
class SodeomSearchProxyFeature extends SodeomSearchBaseFeature
{
    ...
    public function init(SodeomSearchContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SodeomSearchContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
