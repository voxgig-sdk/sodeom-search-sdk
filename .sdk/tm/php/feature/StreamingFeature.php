...
// SodeomSearch SDK streaming feature
...
class SodeomSearchStreamingFeature extends SodeomSearchBaseFeature
{
    ...
    private function _iterate(SodeomSearchResult $result): \Generator
    {
    ...
    private function _streamable(SodeomSearchContext $ctx): bool
    {
