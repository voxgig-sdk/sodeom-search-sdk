...
// SodeomSearch SDK telemetry feature
...
class SodeomSearchTelemetryFeature extends SodeomSearchBaseFeature
{
    ...
    private function _close(SodeomSearchContext $ctx, bool $ok): void
    {
