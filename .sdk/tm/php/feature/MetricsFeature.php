...
// SodeomSearch SDK metrics feature
...
class SodeomSearchMetricsFeature extends SodeomSearchBaseFeature
{
    ...
    private function _record(SodeomSearchContext $ctx, bool $ok): void
    {
