...
// SodeomSearch SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SodeomSearchTransformResponse
{
    public static function call(SodeomSearchContext $ctx): mixed
    {
        ...
        $transform = SodeomSearchHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
