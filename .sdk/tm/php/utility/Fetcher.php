...
// SodeomSearch SDK utility: fetcher

class SodeomSearchFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SodeomSearchSDK/1.0)';
    ...
    public static function call(SodeomSearchContext $ctx, string $fullurl, array $fetchdef): array
    {
