...
// SodeomSearch SDK utility: graphql
//
...
class SodeomSearchGraphql
{
    ...
    // equivalent.
    public static function body(SodeomSearchContext $ctx): mixed
    {
    ...
    public static function errors(SodeomSearchContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
