...
|---|---|---|
| `ts/` | @voxgig-sdk/sodeom-search-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sodeom-search-sdk \
      --repository voxgig-sdk/sodeom-search-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sodeom-search-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sodeom-search-sdk --id=<id>` removes it.
