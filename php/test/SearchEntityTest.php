...
class SearchEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = SodeomSearchSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SODEOM_SEARCH_TEST_SEARCH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function search_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SODEOM_SEARCH_TEST_SEARCH_ENTID");
    ...
    if ($env["SODEOM_SEARCH_TEST_LIVE"] === "TRUE") {
        ...
        $client = new SodeomSearchSDK(Helpers::to_map($merged_opts));
    }
