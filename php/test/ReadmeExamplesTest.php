...
// SodeomSearch SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SodeomSearchSDK::test)
...
{
    private const SDK_CLASS = 'SodeomSearchSDK';
    ...
    private const SDK_BASE = 'sodeomsearch_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../sodeomsearch_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
