...
// SodeomSearch SDK cache feature
...
class SodeomSearchCacheFeature extends SodeomSearchBaseFeature
{
    ...
    private function _through(SodeomSearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
