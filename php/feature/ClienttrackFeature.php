...
// SodeomSearch SDK clienttrack feature
...
class SodeomSearchClienttrackFeature extends SodeomSearchBaseFeature
{
    ...
    public function PostConstruct(SodeomSearchContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SodeomSearch-SDK';
