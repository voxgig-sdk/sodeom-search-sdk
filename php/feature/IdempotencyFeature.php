...
// SodeomSearch SDK idempotency feature
...
class SodeomSearchIdempotencyFeature extends SodeomSearchBaseFeature
{
    ...
    private function _mutating(SodeomSearchContext $ctx): bool
    {
