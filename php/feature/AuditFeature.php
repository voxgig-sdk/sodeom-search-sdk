...
// SodeomSearch SDK audit feature
...
class SodeomSearchAuditFeature extends SodeomSearchBaseFeature
{
    ...
    private function _emit(SodeomSearchContext $ctx, string $outcome): void
    {
