...
// SodeomSearch SDK netsim feature
...
class SodeomSearchNetsimFeature extends SodeomSearchBaseFeature
{
    ...
    private function _simulate(SodeomSearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SodeomSearchContext $ctx, array $applied): void
    {
        $client = $this->client;
