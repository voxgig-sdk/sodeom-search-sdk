...
// SodeomSearch SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SodeomSearchMakeRequest
{
    public static function call(SodeomSearchContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SodeomSearchResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SodeomSearchResponse($fetched);
        } else {
