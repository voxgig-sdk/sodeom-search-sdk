...
// SodeomSearch SDK utility: make_options

class SodeomSearchMakeOptions
{
    ...
    public static function call(SodeomSearchContext $ctx): array
    {
        ...
        //
        // `SodeomSearchSchema::optspec()` is built from the model:
        ...
        $optspec = SodeomSearchSchema::optspec();
