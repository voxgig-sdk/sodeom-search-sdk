...
AQL-driven CLI and REPL for the SodeomSearch SDK. Positional arguments are
...
./sodeom-search-cli load 1 search
./sodeom-search-cli load '{id:1}' search
