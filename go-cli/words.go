...
func registerSDKWords(r *eng.Registry, client *sdk.SodeomSearchSDK) {
...
func runOp(client *sdk.SodeomSearchSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
